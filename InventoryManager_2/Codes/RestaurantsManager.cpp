...
// Globals
map <string, MenuItem *> gMenuItemList;									// Global list of menu items. Here menuItem instance is stored along with its ID.
map <string, int> gRemainingIngredients;								// This global list is used to accumulate all the remaining ingredients from each restaurant at the end of the day.

/****************************************************************************************************************************************************************************************************/
// A map of menuItem ID to menuItem Instance
// Input Parameters: 
...
/****************************************************************************************************************************************************************************************************/
// Function to calculate how much restocking is required at each restaurant.
// Input Parameters: 
...
/*********************************************************************************/
// Adding a new restaurant with restaurantName. If restaraurant name already exist or its menu file doesn't exist then return false. Else return true.
bool RestaurantsManager::addRestaurant(string restaurantName)
{
	...
	else
	{
		...
		string str;
		while(!file.eof())																				// Read the file till we have a menuItem and add it to the menu list.
		{
			file >> str;
...
void RestaurantsManager::stockedFromIngredientFile(Restaurant * r)										// Stock ingredients from the file
{
	string fileBase = "./resourceFiles/";
