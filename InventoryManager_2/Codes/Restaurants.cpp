...
// 	Function used to compare the 2 objects of ExpiryDaysQuantity. This is done to sort the ingredients based on expiry date so that the ingredients with
//	early expiry date can be used first.
